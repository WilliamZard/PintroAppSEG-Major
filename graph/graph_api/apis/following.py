"""All endpoints for handling nodes.
...
# TODO: can this script also be deleted?
...
class FollowRequest(Resource):
    def post(self, follow_requester: str, follow_request_recipient: str) -> Response:
    ...
    def delete(self, follow_requester: str, follow_request_recipient: str) -> Response:
