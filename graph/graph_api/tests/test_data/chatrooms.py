from .users import USERS_PROPERTIES

CHATROOM_USERS = [
    dict(zip(USERS_PROPERTIES, ['password', 'image', 'yes', 'mr a', 'female', '1234',
                                    'Siberia', 'Unknown', 'chatter', 'CHATROOM_A', 'email@email.com', 'i sure love chatting'])),
    dict(zip(USERS_PROPERTIES, ['password', 'image', 'no', 'mr b', 'female', '2345',
                                    'London', 'Unknown', 'student', 'CHATROOM_B', 'email2@email.com', 'talk very good'])),
    dict(zip(USERS_PROPERTIES, ['password', 'image', 'maybe', 'mr c', 'female', '3456',
                                    'Algonquin', 'Unknown', 'homeless', 'CHATROOM_C', 'email3@email.com', 'i have no mouth'])),
    dict(zip(USERS_PROPERTIES, ['password', 'image', 'i dont know', 'mr d', 'female', '4567',
