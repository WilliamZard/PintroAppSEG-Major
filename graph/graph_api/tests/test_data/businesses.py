...
VALID_BUSINESS_TO_BE_CREATED = dict(zip(BUSINESS_PROPERTIES, ['password', 'image', 'Precious', '111',
                                                       'best kiosk in town', 'Gatwickk', 'precious@gmail.com', 'Likeable and devout.']))
...
BUSINESS_ABOUT_TO_FOLLOW = dict(zip(BUSINESS_PROPERTIES, ['password', 'image', 'KingtjWellington', '911',
                                                   'not godless', 'strand', 'no_ucl@kcl.ac.uk', 'What is GKT?']))
...
AFFILIATION_REQUEST_RECIPIENT = dict(zip(BUSINESS_PROPERTIES, ['password', 'image', 'evilcorp', '121',
