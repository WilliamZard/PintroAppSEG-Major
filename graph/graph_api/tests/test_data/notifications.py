...
NOTIFICATION_A = dict(zip(NOTIFICATION_PROPERTIES, [
                      USER_REQUESTING_USER_WITH_NOTIFICATIONS_A['email'], USER_WITH_NOTIFICATIONS['email'], 'follow', 200]))

NOTIFICATION_B = dict(zip(NOTIFICATION_PROPERTIES, [
                      BUSINESS_REQUESTING_AFFILIATION_TO_USER['email'], USER_WITH_NOTIFICATIONS['email'], 'affiliation', 100]))
