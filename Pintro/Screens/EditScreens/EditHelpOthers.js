...
const EditHelpOthers = props => {
    ...
    const [chosenTags,setChosenTags] = useState(useSelector(state => state.user.help_others));
        ...
        <View>
            <View style={{marginHorizontal:30,marginTop:30}}>
                <View style={{marginVertical:20}}>
                    <Text style={{fontSize:25,fontFamily:'Poppins-Bold'}}>How can your help others?</Text>
                </View>
