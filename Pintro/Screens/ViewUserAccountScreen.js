...
const UserAccountScreen = props => {
    ...
    <Text style={styles.location}>{userObj.education} </Text>
                    </View>    
                </View>
            </View>
 ...
 />
            ...
            <FlatList data ={userObj.help_others} renderItem={
  ({item})=> {
